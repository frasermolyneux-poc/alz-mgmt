locals {
  ...
  virtual_network_gateways_express_route = {
    ...
    } if can(hub_network_value.virtual_network_gateways.express_route) && hub_network_value.virtual_network_gateways.express_route != null
  }
  virtual_network_gateways_vpn = {
    ...
    } if can(hub_network_value.virtual_network_gateways.vpn) && hub_network_value.virtual_network_gateways.vpn != null
  }
